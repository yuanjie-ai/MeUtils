from meutils.docarray_.array.document import DocumentArray
from meutils.docarray_.array.storage.weaviate import StorageMixins, WeaviateConfig
...
class DocumentArrayWeaviate(StorageMixins, DocumentArray):
    ...
    .. code-block:: python
        ...
        from meutils.docarray import DocumentArray
