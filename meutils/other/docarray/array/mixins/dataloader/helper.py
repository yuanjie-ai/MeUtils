...
from meutils.docarray_.array.mixins import ParallelMixin, GroupMixin
from meutils.docarray_.helper import protocol_and_compress_from_file_path
...
class DocumentArrayLoader(ParallelMixin, GroupMixin):
    ...
    def __iter__(self):
        ...
        from meutils.docarray_.array.mixins.io.pbar import get_progressbar
