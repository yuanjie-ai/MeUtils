...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from meutils.docarray_.array.mixins.embed import CollateFnType
    from meutils.docarray_.typing import ArrayType, AnyDNN
        ...
        **kwargs,
        ...
        for metric in metrics:
            if callable(metric):
                ...
                from meutils.docarray_.math import evaluation
