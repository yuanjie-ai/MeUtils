# auto-generated from meutils.docarray/scripts/gen_doc_property_mixin.py
from typing import TYPE_CHECKING, Dict, List, Optional, Union, Any

if TYPE_CHECKING:
    from meutils.docarray_.score import NamedScore
    from meutils.docarray_.array.match import MatchArray
    from meutils.docarray_.array.chunk import ChunkArray
    from meutils.docarray_ import DocumentArray
    from meutils.docarray_.typing import ArrayType, StructValueType, DocumentContentType
