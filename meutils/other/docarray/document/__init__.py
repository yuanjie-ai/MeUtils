...
from meutils.docarray_.document.data import DocumentData
from meutils.docarray_.document.mixins import AllMixins
from meutils.docarray_.base import BaseDCType
from meutils.docarray_.math.ndarray import detach_tensor_if_present
...
class Document(AllMixins, BaseDCType):
    ...
    .. code-block:: python
        ...
        from meutils.docarray import Document
        import numpy
