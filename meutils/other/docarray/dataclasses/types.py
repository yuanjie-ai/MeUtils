...
from meutils.docarray_.dataclasses.getter import *
from meutils.docarray_.dataclasses.setter import *
from meutils.docarray_.dataclasses.enums import *
...
from meutils.docarray_.typing import Image, Text, Audio, Video, Mesh, Tabular, Blob, JSON, URI
...
def field(**kwargs) -> Field:
    ...
    .. code-block:: python
        ...
        from meutils.docarray import Document, dataclass, field
...
def dataclass(
    ...
    **kwargs,
    ...
    >>> from meutils.docarray.typing import Image, Text
    >>> from meutils.docarray import dataclass
    >>> @dataclass:
    >>> class X:
